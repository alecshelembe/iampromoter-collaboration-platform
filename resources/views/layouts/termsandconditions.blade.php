...
<div class="max-w-5xl mx-auto p-8 bg-gray-50 rounded-lg shadow-lg mt-10">
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">3. User Accounts</h2>
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">4. Use of the Platform</h2>
        <ul class="list-disc list-inside text-gray-600 space-y-2">
            <li>You may not use the platform for any unlawful or unauthorized purpose.</li>
            <li>You agree not to interfere with the security or integrity of the platform.</li>
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">6. Payments and Refunds</h2>
        <ul class="list-disc list-inside text-gray-600 space-y-2">
            <li>Payments for campaigns, services, or other features must be made as specified on the platform.</li>
            <li>Refunds are subject to our <a href="/refund-policy" class="text-blue-600 underline">Refund Policy</a>.</li>
        </ul>
    </div>
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">10. Governing Law</h2>
        <p class="text-gray-600">
            These terms are governed by the laws of [Your Country/Region]. Any disputes arising from these terms will be subject to the jurisdiction of the courts in [Your Country/Region].
        </p>
    </div>
